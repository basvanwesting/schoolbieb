...
SimpleForm.setup do |config|
  ...
  config.wrappers :horizontal_input_group_form, class: "input-group", hint_class: :field_with_hint, error_class: :field_with_errors, valid_class: :field_without_errors do |b|
    b.use :html5
    b.use :placeholder
  ...
  # inline search forms
  #
  # inline search default_wrapper
  config.wrappers :inline_search_form, tag: 'div' do |b|
    b.use :html5
    b.use :placeholder
  ...
  # inline search input for boolean
  config.wrappers :inline_search_boolean, tag: 'span', class: 'form-check mb-2 mr-sm-2' do |b|
    b.use :html5
