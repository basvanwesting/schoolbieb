...
underscore_translations = {
  /lending(?!_date|Return|Borrow)/ => 'book_use_case',
}

other_translations = {
  /lendingReturn/ => 'bookUseCaseReturn',
  /lendingBorrow/ => 'bookUseCaseBorrow',
  /Lending/       => 'BookUseCase',
}

#rg -i -o --no-line-number --no-filename '\w*lending\w*' | sort | uniq -c
